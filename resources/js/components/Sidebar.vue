  ...
  <div
        ...
        <ul class="list-unstyled flex flex-col gap-1.5">
          ...
          <li>
            <button
              ...
              <span class="whitespace-nowrap group-hover:translate-x-1 transition-transform duration-200">Productos</span>
              <svg class="ml-auto w-4 h-4 transition-transform duration-300"
            ...
            <ul class="relative overflow-hidden transition-all duration-300"
              :style="{ maxHeight: openSubmenus.productoSubmenu ? productoSubmenuHeight + 'px' : '0px' }" ref="productoSubmenu">
          ...
          <li>
            <Link :href="route('industrias.dashboard')"
              class="grid grid-cols-[24px_1fr_24px] items-center gap-1 xl:gap-3 px-1 xl:px-4 py-3 text-white hover:bg-white/10 rounded-lg transition-all duration-200 group cursor-pointer">
            <i class="fa-solid fa-industry text-center w-5 text-white"></i>
            <span
              class="whitespace-nowrap group-hover:translate-x-1 transition-transform duration-200">Industrias</span>
            <span></span>
            </Link>
          </li>
          <li>
    ...
    <div class="mt-auto">
      ...
      <p class="text-gray-300 text-xs text-center px-3">
        <span class="opacity-70 hover:opacity-100 transition-opacity duration-200">@2025 Metac - by Osole</span>
      </p>
    </div>
  </div>
</template>
