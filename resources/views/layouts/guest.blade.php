...
<body class="flex flex-col min-h-screen justify-between bg-white">
    <x-navbar-home :contactos="$contactos" :logos="$logos" :cliente="$cliente ?? null" />
    <main class="overflow-x-hidden h-full {{ request()->routeIs('home') ? '' : 'mt-[90px]' }}">
        @yield('content')
    </main>
