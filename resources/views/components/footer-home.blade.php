...
<footer class="text-white">
    <div class="bg-[#333333]">
        <div
            ...
            <div class="lg:w-1/4 flex flex-col items-center">
                ...
                <div
                    class="flex flex-col gap-3.5 items-center lg:items-start justify-center mt-4 text-center lg:text-left text-sm lg:text-base">
                    @foreach ($contactos as $contacto)
                            ...
                            <a href="https://wa.me/{{ $contacto->whatsapp }}"
                                ...
                                <div class="flex gap-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                      <g clip-path="url(#clip0_4333_1988)">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M17.0858 2.9063C15.206 1.0331 12.7059 0.000975688 10.042 0C4.55286 0 0.0854902 4.44547 0.0835686 9.90971C0.0826275 11.6565 0.54149 13.3615 1.4129 14.8641L0 20L5.2791 18.6219C6.73349 19.4117 8.37126 19.8275 10.0377 19.828H10.042C15.5302 19.828 19.9981 15.3821 20 9.91779C20.0009 7.26958 18.9662 4.78001 17.0858 2.90677V2.9063ZM10.042 18.1543H10.0387C8.55365 18.1539 7.09686 17.7566 5.8258 17.0063L5.52357 16.8276L2.39078 17.6454L3.22686 14.6056L3.03012 14.2939C2.20169 12.9823 1.76384 11.4664 1.76478 9.91022C1.76671 5.36874 5.47965 1.67362 10.0454 1.67362C12.2561 1.67459 14.3342 2.53234 15.8969 4.08954C17.4598 5.64627 18.3197 7.71625 18.3187 9.91685C18.3168 14.4588 14.6039 18.1539 10.042 18.1539V18.1543ZM14.5819 11.9854C14.3331 11.8614 13.1099 11.2626 12.8816 11.1799C12.6534 11.0972 12.4877 11.0559 12.322 11.3039C12.1563 11.552 11.6793 12.1099 11.5342 12.2747C11.389 12.4401 11.2438 12.4606 10.9951 12.3365C10.7463 12.2125 9.94459 11.9512 8.99392 11.1077C8.25431 10.4509 7.75482 9.6403 7.60973 9.39221C7.46455 9.14419 7.59443 9.01016 7.71855 8.88707C7.83027 8.77592 7.96733 8.59772 8.09196 8.45324C8.21659 8.30876 8.25765 8.20522 8.34071 8.04029C8.42384 7.87489 8.38227 7.73053 8.32024 7.60642C8.25812 7.48243 7.76059 6.26353 7.55286 5.76792C7.35086 5.28514 7.14561 5.35071 6.99329 5.34263C6.84808 5.33549 6.68243 5.33409 6.51627 5.33409C6.35012 5.33409 6.08078 5.39583 5.85255 5.64392C5.62431 5.89191 4.98161 6.49117 4.98161 7.70953C4.98161 8.92797 5.8731 10.106 5.99773 10.2714C6.12231 10.4367 7.75243 12.9377 10.2483 14.0107C10.8418 14.2658 11.3054 14.4184 11.6669 14.5324C12.2628 14.7211 12.8052 14.6945 13.234 14.6308C13.712 14.5595 14.7061 14.0316 14.9133 13.4532C15.1205 12.8749 15.1205 12.3788 15.0585 12.2757C14.9964 12.1726 14.8303 12.1103 14.5815 11.9863L14.5819 11.9854Z" fill="#A2D32D"/>
                                      </g>
                                      <defs>
                                        <clipPath id="clip0_4333_1988">
                                          <rect width="20" height="20" fill="white"/>
                                        </clipPath>
                                      </defs>
                                    </svg>
    ...
    <div class="bg-[#2E2E2E]">
        <div
            ...
            <p>{{ __('漏 Copyright 2025 Metac S.A. Todos los derechos reservados') }}</p>
            <p>{{ __('By') }}
                    ...
                    axios.post('{{ route('newsletter.store') }}', {
                        ...
                        .then(function() {
                            messageDiv.innerHTML =
                                '<span class="text-green-500">{{ __('Suscripci贸n exitosa') }}</span>';
                            form.reset();
                            setTimeout(() => {
                                messageDiv.innerHTML = '';
                            }, 3000);
                        ...
                        .catch(function(error) {
                            ...
                            else if (error.request) msg += 'No se recibi贸 respuesta del servidor';
