...
@section('title', __('Fichas Técnicas'))
...
@section('content')
    <div>
                ...
                <div class="absolute top-6 left-0">
                    <div class="flex gap-1 text-xs">
                        ...
                        <a href="{{ route('zonaprivada.fichatecnica') }}"
                            class="font-extralight hover:underline">{{ __('Fichas técnicas') }}</a>
                    </div>
                </div>
        ...
        <div class="max-w-[90%] lg:max-w-[1224px] mx-auto py-20 min-h-[500px]">
            ...
            <div id="sin-resultados" class="hidden text-center py-8">
                <p class="text-black">No se encontraron fichas técnicas con los criterios seleccionados.</p>
            </div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Mostrar todas las fichas técnicas al cargar la página
            function mostrarTodasLasFichas() {
                const todasLasFichas = productos.filter(producto => {
                    return producto.fichatecnica && producto.fichatecnica.trim() !== '';
                });
            ...
            // Función para cargar todos los productos con ficha técnica
            function cargarTodosLosProductos() {
                productoSelect.innerHTML = '<option value="">Seleccionar producto</option>';
                productoSelect.disabled = false;

                const productosConFicha = productos.filter(producto =>
                    producto.fichatecnica && producto.fichatecnica.trim() !== ''
                );
            ...
            function buscarAutomaticamente() {
                ...
                // Filtrar productos con ficha técnica
            ...
            limpiarBtn.addEventListener('click', function() {
                ...
                // Mostrar todas las fichas técnicas
                mostrarTodasLasFichas();
            });
            ...
            function mostrarResultados(productos) {
                ...
                productos.forEach(producto => {
                    ...
                    fila.innerHTML = `
                        ...
                        <div>
                            <div class="text-[#333]">Ficha Técnica ${producto.titulo}</div>
                        </div>
